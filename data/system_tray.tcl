...
proc system_trayToggle {handler} {
	...
	if {[winfo exists .tray] == 1} {
		if {$handler == 0} {
			...
			set doIt 0
			set w {.station .station.top_AddEdit .station.top_searchUi .station.top_search .config_wizard .config_wizard.fontchooser .top_about .top_cp_progress .top_diagnostic .record_wizard.add_edit .record_wizard.add_edit.date .error_w .key.f_key_treeview.tv_key.w_keyEdit .__ttk_filedialog .log_viewer.__ttk_filedialog}
			foreach window $w {
