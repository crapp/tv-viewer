...
set option(release_version) "0.8.1a1.17"

# Start options for the program
array set start_options {--version 0 --help 0}
foreach argumente $argv {set start_options($argumente) 1}
if {[array size start_options] != 2} {
	puts "
TV-Viewer Diagnostic Routine $option(release_version)
...
This version is compatible with TV-Viewer $option(release_version)
"
	exit 0
}
...
#Opening output file
puts $diag_file "TV-Viewer Diagnostic routine Version $option(release_version) -- Created: $actual_date
...
set modcheck [catch {agrep -m "$read_lsmod" ivtv} resultat_modcheck]
puts $diag_file_append "
***********************************************************************
Modcheck:
$resultat_modcheck"
set modcheck2 [catch {agrep -m "$read_lsmod" pvrusb2} resultat_modcheck2]
puts $diag_file_append "
***********************************************************************
Modcheck(pvrusb2):
$resultat_modcheck2"
set modcheck3 [catch {agrep -m "$read_lsmod" cx18} resultat_modcheck3]
puts $diag_file_append "
***********************************************************************
Modcheck(cx18):
$resultat_modcheck3"
...
set dmesgcheck [catch {agrep -m "$read_dmesg" ivtv} resultat_dmesgcheck]
puts $diag_file_append "
***********************************************************************
Dmesgcheck(ivtv):
$resultat_dmesgcheck"
set dmesgcheck2 [catch {agrep -m "$read_dmesg" pvrusb2} resultat_dmesgcheck2]
puts $diag_file_append "
***********************************************************************
Dmesgcheck(pvrusb2):
$resultat_dmesgcheck2"
set dmesgcheck3 [catch {agrep -m "$read_dmesg" cx18} resultat_dmesgcheck3]
puts $diag_file_append "
***********************************************************************
Dmesgcheck(cx18):
...
Configuration:"
	foreach {key elem} [array get option] {
		catch {puts $diag_file_append "$key $elem"}
	}
} else {
	puts $diag_file_append "
***********************************************************************
...
if {[string trim [auto_execok mplayer]] != {}} {
	...
	puts $diag_file_append "Mplayer_ver:
$mplayer_ver"
}
