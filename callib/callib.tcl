#       callib.tcl
#       © Copyright 2005-2009 Jaafar Mejri http://wiki.tcl.tk/13498
#       Additions made by Christian Rapp
#       
...
#       MA 02110-1301, USA.
 ...
 namespace eval callib {
    ...
    ##################################
        ...
        #font defaults
        set calState($holder.font) [list TkDefaultFont 12 normal]
        #day names, change the defaults to the language needed
        set calState($holder.daynames) [list [mc "Sun"] [mc "Mon"] [mc "Tue"] [mc "Wed"] [mc "Thu"] [mc "Fri"] [mc "Sat"]]
        #day font
        set calState($holder.dayfont) [list TkDefaultFont 12 bold]
